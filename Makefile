...
define PROJ_semant_tester
	...
	SOURCES = absyn/absyn.ml absyn/table.ml absyn/symbol.ml parser/tigerparse.mly lexer/tigerlex_intf.ml lexer/tigerlex.mll parser/parsertokens.ml semant/types.ml semant/translate.mli semant/env.ml semant/semant.ml
	YFLAGS = --explain --trace --dump
endef
